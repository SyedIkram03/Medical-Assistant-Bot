...
def sample(input_text):
    ...
    if message.find("symptom")!=-1 or message.find("symptoms")!=-1:
        ...
        return("Welcome onboard!\n We are Team Medi-Assist\n\nPlease type in the following to help us reach you\n1. /help: This gives you a complete description about our work and what we intend to do \n2. 'Symptoms are ': This helps us understand your symptoms and give you a basic layout of what needs to be done. \n3. 'hospitals in': We give you lists of hospitals in your area so that you can rush in immediately. \n4. /feedback: For your valuable feedback. \n5. /BMI (weight) (height): To get you Body Mass Index. \n6. /exit: To terminate our service for the moment. \n We hope this helps!")


# print(sample(input("Enter Symptoms/description:")))
